...
export function handleSelect() {
  daftplugAdmin.find('select[data-dp-select]:not([data-processed="true"])').each(function () {
    ...
    options.each(function (index) {
      ...
      optionTags += `
        <div data-value="${value}" tabindex="${index}" class="group data-[selected=true]:bg-gray-100 dark:data-[selected=true]:bg-neutral-800 py-2 px-4 w-max ${textSizeClass} text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200">
