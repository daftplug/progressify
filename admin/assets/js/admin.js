(() => {
    ...
    !function(t, e) {
      ...
      var C = { name: "en", options: { months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", exportToCSV: "Download CSV", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" } } }, L = function() {
        ...
        return r(t2, [{ key: "drawGridArea", value: function() {
          ...
          } else i2 = a2, a2 = t3.globals.xTickAmount, this._drawInvertedXYLines({ xCount: i2, tickAmount: a2 });
        ...
        return r(t2, [{ key: "niceScale", value: function(t3, e2) {
          ...
          if ("dataPoints" === (i2 = this._adjustTicksForSmallRange(i2, a2, o2)) && (i2 = r2.globals.dataPoints - 1), t3 === Number.MIN_VALUE && 0 === e2 || !x.isNumber(t3) && !x.isNumber(e2) || t3 === Number.MIN_VALUE && e2 === -Number.MAX_VALUE) return t3 = 0, e2 = i2, this.linearScale(t3, e2, i2, a2, r2.config.yaxis[a2].stepSize);
          ...
          if (r2.logarithmic && o2 <= 5 && (a2.invalidLogScale = true), r2.logarithmic && o2 > 5) a2.allSeriesCollapsed = false, a2.yAxisScale[t3] = this.logarithmicScale(e2, i2, r2.logBase), a2.yAxisScale[t3] = r2.forceNiceScale ? this.logarithmicScaleNice(e2, i2, r2.logBase) : this.logarithmicScale(e2, i2, r2.logBase);
          else if (i2 !== -Number.MAX_VALUE && x.isNumber(i2)) if (a2.allSeriesCollapsed = false, void 0 === r2.min && void 0 === r2.max || r2.forceNiceScale) {
          ...
          } else a2.yAxisScale[t3] = this.linearScale(e2, i2, r2.tickAmount, t3, s2.yaxis[t3].stepSize);
          else a2.yAxisScale[t3] = this.linearScale(0, 5, 5, t3, s2.yaxis[t3].stepSize);
        ...
        function t2(e2) {
          a(this, t2), this.ctx = e2, this.w = e2.w, this.scales = new _2(e2);
        }
        return r(t2, [{ key: "init", value: function() {
        ...
        return r(t2, [{ key: "init", value: function() {
          ...
          for (var o2 = e2.globals.legendFormatter, n2 = e2.config.legend.inverseOrder, l2 = n2 ? a2.length - 1 : 0; n2 ? l2 >= 0 : l2 <= a2.length - 1; n2 ? l2-- : l2++) {
            ...
            if (!e2.config.legend.showForZeroSeries) 0 === M2.getSeriesTotalByIndex(l2) && M2.seriesHaveSameValues(l2) && !M2.isSeriesNull(l2) && -1 === e2.globals.collapsedSeriesIndices.indexOf(l2) && -1 === e2.globals.ancillaryCollapsedSeriesIndices.indexOf(l2) && P2.classList.add("apexcharts-hidden-zero-series");
        ...
        return r(t2, [{ key: "createToolbar", value: function() {
          ...
          if (void 0 !== t3 || void 0 !== e2) {
            if (!(i2.config.xaxis.convertedCatToNumeric && (t3 < 1 && (t3 = 1, e2 = i2.globals.dataPoints), e2 - t3 < 2))) {
              ...
              if (i2.config.chart.zoom.autoScaleYaxis) o2 = new _2(this.ctx).autoScaleY(this.ctx, o2, { xaxis: a2 });
        ...
        return r(i2, [{ key: "init", value: function(t3) {
          ...
          i3.config.chart.zoom.autoScaleYaxis && (s2 = new _2(this.ctx).autoScaleY(this.ctx, s2, { xaxis: l2 }));
        ...
        return r(t2, [{ key: "draw", value: function(t3) {
          ...
          var e2 = this.w, i2 = new _2(this.ctx), a2 = new m(this.ctx), s2 = new Ct(this.ctx), r2 = a2.group(), o2 = a2.group(), n2 = i2.niceScale(0, Math.ceil(this.maxY), e2.config.yaxis[0].tickAmount, 0, true), l2 = n2.result.reverse(), h2 = n2.result.length;
      ...
      var Ft = function() {
        ...
        return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
          ...
          }), o2.config.chart.stacked) for (var M2 = d2.length; M2 > 0; M2--) h2.add(d2[M2 - 1]);
          ...
          for (var E2 = function(t4, e3) {
            ...
            if (F2) if (n2 > 0 && S2.globals.collapsedSeries.length < S2.config.series.length - 1) {
          ...
          switch (t3[0]) {
            ...
            case "A":
              e3 = function(t4, e4) {
                ...
                if (0 === I2 || 0 === T2 || F2.x === R2.x && F2.y === R2.y) return [["C", F2.x, F2.y, R2.x, R2.y, R2.x, R2.y]];
                ...
                for (b2[0][0] = b2[0][1].clone(), b2[b2.length - 1][2] = b2[b2.length - 1][1].clone(), s3 = new SVG.Matrix().rotate(M2).scale(I2, T2).rotate(-M2), k2 = 0, A2 = b2.length; k2 < A2; k2++) b2[k2][0] = b2[k2][0].transform(s3), b2[k2][1] = b2[k2][1].transform(s3), b2[k2][2] = b2[k2][2].transform(s3);
  ...
  function handleAppScreenshotsUpload() {
    ...
    const maxFiles = 5;
    const defaultScreenshots = [`https://s0.wp.com/mshots/v1/${(_b = (_a = config.jsVars.settings.webAppManifest) == null ? void 0 : _a.displaySettings) == null ? void 0 : _b.startPage}?vpw=750&vph=1334&format=png`, `https://s0.wp.com/mshots/v1/${(_d = (_c = config.jsVars.settings.webAppManifest) == null ? void 0 : _c.displaySettings) == null ? void 0 : _d.startPage}?vpw=1280&vph=800&format=png`];
  ...
  var SubscriberManager = class {
    ...
    updateSubscribersList(data) {
      ...
      `;
        ...
        (_b = this.sendNotificationButton) == null ? void 0 : _b.classList.add("hidden");
      ...
      (_c = this.thead) == null ? void 0 : _c.classList.remove("hidden");
      (_d = this.sendNotificationButton) == null ? void 0 : _d.classList.remove("hidden");
      if (this.totalDisplay) {
