(() => {
  // admin/assets/js/dev/components/utils.js
  function navigateToPage(pageId, subPageId = "", scrollToTop = true) {
  ...
  function highlightElement(selector) {
    ...
    scrollIntoViewPromise.then(() => spotlight()).catch((error) => {
      console.error("Error during highlight animation:", error);
    });
  }
  function findAndHighlightElement(selector) {
    const element = document.querySelector(selector);
  ...
  function validateAttachment(attachment, mimes, maxWidth, minWidth, maxHeight, minHeight) {
    const errors = [];
    if (mimes && mimes !== "") {
  ...
  var utils_default = jQuery;

  // admin/assets/js/dev/components/select.js
  function initSelect() {
    handleSelect();
  }
  function handleSelect() {
    config.daftplugAdminElm.find('select[data-dp-select]:not([data-processed="true"])').each(function() {
      ...
      const selectConfig = JSON.parse(self2.attr("data-dp-select") || "{}");
      ...
      const isMultiple = self2.attr("multiple") !== void 0;
      const hasSelectedOption = self2.find("option:selected[selected]").length > 0;
      if (!isMultiple && !hasSelectedOption) {
        self2.prop("selectedIndex", -1).trigger("change");
      }
      const options = self2.find("option").not('[value=""]');
      let optionTags = "";
      options.each(function(index) {
        ...
        const icon = (_a = optionConfig.icon) != null ? _a : "";
        const description = (_b = optionConfig.description) != null ? _b : "";
        let iconMarkup = "";
      ...
      self2.addClass("absolute pointer-events-none inset-0 appearance-none opacity-0 mx-auto peer");
      self2.wrapAll('<div class="relative"></div>');
      const wrapper = self2.parent(".relative");
      wrapper.append(`
    ...
    `);
      ...
      const initialValue = self2.val();
      if (initialValue) {
        updateCustomSelect(self2, toggle, dropdown, initialValue, placeholder, isMultiple);
      }
      const observer = new IntersectionObserver(
        (entries) => {
      ...
      wrapper.on("keydown", function(e) {
        if (!dropdown.hasClass("hidden")) {
          const options2 = optionsContainer.find("[data-value]:not(.hidden)");
          const currentFocus = document.activeElement;
          const currentIndex = options2.index(currentFocus);
          switch (e.key) {
            case "ArrowDown":
              e.preventDefault();
              if (currentIndex < options2.length - 1) {
                options2.eq(currentIndex + 1).focus();
              }
              break;
            case "ArrowUp":
              e.preventDefault();
      ...
      dropdown.on("click", "[data-value]", function(event) {
        ...
        self2.val(selectedValues).trigger("change");
        updateCustomSelect(self2, toggle, dropdown, selectedValues, placeholder, isMultiple);
      });
      self2.on("change", function() {
        const selectedValues = self2.val() || [];
        updateCustomSelect(self2, toggle, dropdown, selectedValues, placeholder, isMultiple);
      });
      ...
      self2.attr("data-processed", true);
    });
  }
  ...
  function updateCustomSelect(select, toggle, dropdown, selectedValues, placeholder, isMultiple) {
    ...
    if (selectedValues.length === 0) {
      ...
      const selectedOptions = displayedItems.map((value, index) => {
  ...
  // admin/assets/js/dev/components/pagePathInput.js
  function handlePagePathInput() {
    config.daftplugAdminElm.find('#pagePathInput:not([data-processed="true"])').each(function() {
      const self2 = jQuery(this);
      const input = self2.find("input");
  ...
  // admin/assets/js/dev/components/copyMarkup.js
  function initCopyMarkup() {
    handleCopyMarkup();
  }
  function handleCopyMarkup() {
    config.daftplugAdminElm.find("[data-dp-copy-markup]").each(function() {
      const self2 = jQuery(this);
      const copyMarkupConfig = JSON.parse(self2.attr("data-dp-copy-markup"));
      ...
      function checkLimit() {
        const visibleTargets = wrapperElement.find(`[data-dp-copy-markup-target^="${target}"]`);
        if (visibleTargets.length >= limit) {
          self2.attr("data-disabled", true);
        } else {
          self2.removeAttr("data-disabled");
        }
    ...
    elements.each(function(index, el) {
      ...
      formEls.each(function() {
        ...
        if (match && match.length === 3) {
          const index2 = match[1];
          const key = match[2];
          const path = name.substring(0, name.lastIndexOf(`[${index2}][${key}]`)).replace(/\[/g, ".").replace(/\]/g, "");
          let value = typeof config.jsVars.settings === "object" ? config.jsVars.settings : void 0;
          if (value) {
            ...
            if (value && Array.isArray(value) && value[index2] && typeof value[index2] === "object" && key in value[index2]) {
              const settingValue = value[index2][key];
              if (formEl.is("select")) {
  ...
  function findKey(obj, targetKey) {
    let result = [];
    function search(obj2, targetKey2) {
      ...
      for (const key in obj2) {
        if (obj2.hasOwnProperty(key)) {
          if (key === targetKey2) {
            result = Array.isArray(obj2[key]) ? obj2[key] : [];
            return;
          } else if (typeof obj2[key] === "object" && obj2[key] !== null) {
            search(obj2[key], targetKey2);
          }
        }
      }
    }
  ...
  // admin/assets/js/dev/components/dependentMarkup.js
  function initDependentMarkup() {
    handleDependentMarkup();
  }
  function handleDependentMarkup() {
    config.daftplugAdminElm.find("[data-dp-dependant-markup]").each(function() {
      const self2 = jQuery(this);
      const dependentMarkupConfig = JSON.parse(self2.attr("data-dp-dependant-markup"));
      ...
      function updateState() {
        ...
        self2.find("[data-dp-dependant-markup]").each(function() {
      ...
      function updateDependentMarkup(element) {
        const dependentMarkupConfig2 = JSON.parse(element.attr("data-dp-dependant-markup"));
        const target2 = dependentMarkupConfig2.target;
        const state2 = dependentMarkupConfig2.state || "checked";
        const mode2 = dependentMarkupConfig2.mode || "availability";
        const targetElement2 = config.daftplugAdminElm.find(`[name="${target2}"]`);
        const isChecked = targetElement2.is(":checked");
        const shouldActivate = state2 === "checked" ? isChecked : !isChecked;
        if (mode2 === "availability") {
          if (shouldActivate) {
      ...
      self2.find("input, select, textarea").each(function() {
        const field = jQuery(this);
  ...
  // admin/assets/js/dev/components/clipboard.js
  ...
  // admin/assets/js/dev/components/inputValidation.js
  ...
  function validateInputs() {
    ...
    inputs.each(function() {
      const self2 = jQuery(this);
      self2.on("invalid", function(e) {
        self2.attr("data-invalid", "true");
        setTimeout(function() {
          self2.removeAttr("data-invalid");
        }, 2300);
      });
    });
  }

  // admin/assets/js/dev/components/tooltip.js
  ...
  function setupTooltips(container = config.daftplugAdminElm) {
    ...
    tooltips.each(function() {
      const self2 = jQuery(this);
      if (self2.data("tooltip-initialized")) {
        return;
      }
      const content = self2.find(".dp-tooltip-content");
      const tooltipConfig = JSON.parse(self2.attr("data-dp-tooltip"));
      ...
      const showTooltip = () => {
        self2.attr("data-shown", true);
      };
      const hideTooltip = () => {
        self2.attr("data-shown", false);
      };
      if (trigger === "hover") {
        self2.on("mouseenter", showTooltip);
        self2.on("mouseleave", hideTooltip);
      } else if (trigger === "click") {
        self2.on("click", (event) => {
          event.stopPropagation();
          if (self2.attr("data-shown") === "true") {
            hideTooltip();
          } else {
            hideAllTooltips();
            showTooltip();
        ...
        jQuery(document).on("click", function(event) {
          if (!self2.is(event.target) && self2.has(event.target).length === 0) {
            hideTooltip();
          }
        });
      }
      self2.data("tooltip-initialized", true);
    });
  }
  ...
  // admin/assets/js/dev/components/overlay.js
  ...
  // admin/assets/js/dev/components/dropdown.js
  ...
  function setupDropdowns(container = config.daftplugAdminElm) {
    ...
    dropdowns.each(function() {
      const self2 = jQuery(this);
      if (self2.data("dropdown-initialized")) {
        return;
      }
      const toggle = self2.find(".dp-dropdown-toggle");
      const menu = self2.find(".dp-dropdown-menu");
      const dropdownConfig = JSON.parse(self2.attr("data-dp-dropdown"));
      const trigger = dropdownConfig.trigger || "click";
      const openDropdown = () => {
        self2.attr("data-open", true);
        positionDropdown2(menu, toggle);
      };
      const hideDropdown = () => {
        self2.attr("data-open", false);
      };
      ...
      const debouncedPositioning = debounce2(() => handleDropdownPositioning2(menu, toggle), 100);
      window.addEventListener("scroll", debouncedPositioning, { passive: true });
      window.addEventListener("resize", debouncedPositioning, { passive: true });
      self2.data("dropdown-initialized", true);
    });
  }
  ...
  function positionDropdown2(menu, toggle) {
  ...
  function handleDropdownPositioning2(menu, toggle) {
    if (!menu.hasClass("hidden")) {
      positionDropdown2(menu, toggle);
    }
  }

  // admin/assets/js/dev/components/toast.js
  function showToast(title, description, type, position = "bottom-right", autodismiss = true, dismissible = false, actionMarkup = "") {
    const icons = {
  ...
  // admin/assets/js/dev/modules/processLicense.js
  function initProcessLicense() {
  ...
  // admin/assets/js/dev/modules/introGuide.js
  ...
  function startIntroGuide() {
    ...
    introJs("#daftplugAdminWrapper").setOptions({
      dontShowAgain: false,
      showBullets: false,
      showProgress: true,
      hidePrev: true,
  ...
  // admin/assets/js/dev/components/pwaAssetGenerator.js
  ...
  function generateSingleSplashScreen(icon, backgroundColor, deviceConfig, isLandscape = false) {
    ...
    const targetIconSize = calculateIconSize(dimensions.width, dimensions.height, deviceConfig.device);
  ...
  async function generateAndSendPwaAssets(iconUrl, backgroundColor, batchSize = 10) {
    if (!iconUrl || !backgroundColor) {
      throw new Error("Both iconUrl and backgroundColor are required");
    }
  ...
  // admin/assets/js/dev/modules/settings.js
  ...
  async function saveSettings(e) {
    e.preventDefault();
    const form = utils_default(e.target);
  ...
  // admin/assets/js/dev/modules/search.js
  function initSearch() {
  ...
  function buildSettingsItems() {
    ...
    sections.each(function() {
      ...
      const pageTitle = pageId.replace(/([A-Z])/g, " $1").replace(/^./, (str) => str.toUpperCase()).trim();
      let groupItemsHTML = "";
      ...
      fieldsets.each(function() {
        ...
        const fieldsetTitle = titleElement.contents().filter(function() {
  ...
  // admin/assets/js/dev/components/apexcharts.js
  function initApexcharts() {
    !function(t, e) {
      ...
      const _2 = {}, N = "___SYMBOL___ROOT___";
      function W(t2, e2 = E) {
      ...
      function q(t2, e2 = t2.name, i2 = false) {
        return _2[e2] = t2, i2 && (_2[N] = t2), S(Object.getOwnPropertyNames(t2.prototype)), t2;
      }
      let Z = 1e3;
      function $(t2) {
        return "Svgjs" + P(t2) + Z++;
      ...
      let Gt = class extends Bt {
        constructor(t2, e2) {
          var _a2, _b;
          super(t2, e2), this.dom = {}, this.node.instance = this, (t2.hasAttribute("data-svgjs") || t2.hasAttribute("svgjs:data")) && this.setData((_b = (_a2 = JSON.parse(t2.getAttribute("data-svgjs"))) != null ? _a2 : JSON.parse(t2.getAttribute("svgjs:data"))) != null ? _b : {});
        }
        center(t2, e2) {
      ...
      class Qe extends Rt {
        ...
        static sanitise(t2, e2, i2) {
          ...
          return e2 = e2 != null ? e2 : Ot, i2 = i2 || "last", "object" != typeof (t2 = t2 != null ? t2 : Yt) || t2 instanceof ye || (e2 = (_a2 = t2.delay) != null ? _a2 : e2, i2 = (_b = t2.when) != null ? _b : i2, s2 = t2.swing || s2, a2 = (_c = t2.times) != null ? _c : a2, r2 = (_d = t2.wait) != null ? _d : r2, t2 = (_e2 = t2.duration) != null ? _e2 : Yt), { duration: t2, delay: e2, swing: s2, times: a2, wait: r2, when: i2 };
        }
        active(t2) {
      ...
      class oi extends qt {
        constructor(t2, e2 = t2) {
          var _a2;
          super(G("text", t2), e2), this.dom.leading = (_a2 = this.dom.leading) != null ? _a2 : new _t(1.3), this._rebuild = true, this._build = false;
        }
        leading(t2) {
        ...
        return s(t2, [{ key: "getStackedSeriesTotals", value: function() {
          ...
          s2.forEach(function(t4) {
            ...
            t4.forEach(function(t5) {
              e2.series[t5] && void 0 === e2.series[t5].group && (e2.series[t5].__apexParsed ? e2.series[t5].group = "apexcharts-axis-".concat(t5.toString()) : e2.series[t5].group = "apexcharts-axis-".concat(i3.toString()));
            });
          });
      ...
      var Hi = { name: "en", options: { months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", exportToCSV: "Download CSV", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" } } }, Oi = function() {
        ...
        return s(t2, [{ key: "niceScale", value: function(t3, e2) {
          ...
          var _3 = t3 - b2, N2 = b2 * o2;
          do {
            _3 += b2, p2.push(v.stripNumber(_3, 7));
          } while (e2 - _3 > N2);
      ...
      var Ga = function() {
        ...
        return s(t2, [{ key: "draw", value: function(t3, e2, i2, a2) {
          ...
          for (var F2, D2 = 0, _3 = 0; _3 < n2 && 0 !== r2[h2].length; _3++) {
            var N2 = void 0 === r2[h2][_3 + 1] || null === r2[h2][_3 + 1];
            ...
            N2 ? d2 = E2(R2, m2) : (d2 = E2(r2[h2][_3 + 1], m2), "rangeArea" === s2 && (Y2 = E2(C2[h2][_3 + 1], m2))), y2.push(null === r2[h2][_3 + 1] ? null : c2), !N2 || "smooth" !== S2.config.stroke.curve && "monotoneCubic" !== S2.config.stroke.curve ? (w2.push(d2), k2.push(Y2)) : (w2.push(null), k2.push(null));
            var B2 = this.lineHelpers.calculatePoints({ series: r2, x: c2, y: d2, realIndex: o2, i: h2, j: _3, prevY: P2 }), G2 = this._createPaths({ type: s2, series: r2, i: h2, realIndex: o2, j: _3, x: c2, y: d2, y2: Y2, xArrj: y2, yArrj: w2, y2Arrj: k2, pX: u2, pY: g2, pathState: D2, segmentStartX: F2, linePath: I2, areaPath: T2, linePaths: f2, areaPaths: x2, curve: O2, isRangeStart: A2 });
              ...
              if (null === i2[a2][r2]) p2 = 0;
                ...
                case 1:
                  if (null === i2[a2][r2 + 1]) x2 += S2 ? k2.line(u2, c2) : k2.move(u2, g2), b2 += k2.line(u2, A2) + k2.line(f2, A2) + "z", m2.push(x2), v2.push(b2), p2 = -1;
                    ...
                    var _3 = F2(y2, n2, o2);
                    x2 += _3, b2 += _3, r2 >= i2[a2].length - 2 && (S2 && (x2 += k2.line(n2, c2)), b2 += k2.line(n2, A2) + k2.line(f2, A2) + "z", m2.push(x2), v2.push(b2), p2 = -1);
                  }
              }
              u2 = n2, g2 = o2;
          }
      ...
      const Ja = (t2) => (t2.changedTouches && (t2 = t2.changedTouches[0]), { x: t2.clientX, y: t2.clientY });
      class Qa {
        constructor(t2) {
      ...
      const is = (t2) => function(e2 = true, i2 = {}) {
      ...
      const ns = (t2) => function(e2 = true, i2 = {}) {
        "object" == typeof e2 && (i2 = e2, e2 = true);
        let a2 = this.remember("_" + t2.name);
      ...
      const os = (t2) => (t2.changedTouches && (t2 = t2.changedTouches[0]), { x: t2.clientX, y: t2.clientY }), ls = (t2) => {
        let e2 = 1 / 0, i2 = 1 / 0, a2 = -1 / 0, s2 = -1 / 0;
  ...
  // admin/assets/js/dev/modules/pwaUsersData.js
  var PwaUsersDataManager = class {
    constructor() {
      this.usersData = null;
    ...
    filterInstallationsByPeriod() {
      var _a;
      if (!((_a = this.usersData) == null ? void 0 : _a.installations.length)) {
      ...
      const installationsMap = new Map(
        this.usersData.installations.filter((item) => {
          const d = new Date(item.date);
    ...
    generateBrowserMessage(browsers) {
      if (!(browsers == null ? void 0 : browsers.length) || !browsers[0].browser_name) {
      ...
      this.chart.updateOptions(
        {
          ...
          yaxis: {
            min: emptyData ? 0 : void 0,
            max: emptyData ? 10 : void 0,
            labels: {
              align: "left",
              style: {
                colors: "#9ca3af",
              ...
              formatter: (val) => val >= 1e3 ? `${val / 1e3}k` : val
            }
          },
          tooltip: {
  ...
  function initPwaUsersData() {
    const pwaUsersDataManager = new PwaUsersDataManager();
    pwaUsersDataManager.init();
  }

  // admin/assets/js/dev/modules/pwaScoreData.js
  var PwaScoreDataManager = class {
    constructor() {
      this.scoreData = null;
    ...
    setupEventListeners() {
      this.pwaScoreActions.addEventListener("click", async (e) => {
        ...
        const highlightElement2 = actionItem.dataset.findAndHighlightElement;
        if (actionType === "click" && highlightElement2) {
          findAndHighlightElement(highlightElement2);
        }
      });
    }
    async loadData() {
    ...
    generateActionItems(actionItems) {
        ...
        <div class="relative px-5 py-6 mt-5 flex flex-col rounded-xl justify-center items-center text-center bg-gray-100">
          <div class="max-w-md mx-auto text-wrap">
            <p class="text-base font-medium text-gray-800">
              ${wp.i18n.__("No Action Items", config.jsVars.slug)}
            </p>
            <p class="mt-0.5 text-sm text-gray-500">
              ${wp.i18n.__("Your PWA seems fully setup and your score is excellent.", config.jsVars.slug)}
            </p>
          </div>
        </div>
      `;
      ...
      <div class="relative mt-5 flex flex-col">
        <h3 class="mb-1.5 text-sm text-gray-500">${wp.i18n.__("Action Items", config.jsVars.slug)}</h3>
        ...
        ${actionItems.length > 2 ? `
          <button onclick="this.previousElementSibling.classList.add('expanded');this.remove();" class="absolute z-30 bottom-0 self-center py-1.5 px-2.5 inline-flex items-center gap-x-1 text-xs font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none">
            ...
            <span>${wp.i18n.__("Show All", config.jsVars.slug)} (${actionItems.length})</span>
          </button>
        ` : ""}
      </div>
    `;
  ...
  function handleAppIconUpload() {
    ...
    appIconUploadBtn.on("click", function(e) {
      ...
      frame.on("select", function() {
        ...
        const imageSrc2 = attachment.url;
        appIconInput.val(attachment.id).trigger("change");
        attachmentHolder.attr("src", imageSrc2);
        updateUIState();
      });
      frame.open();
    });
  ...
  // admin/assets/js/dev/modules/appShortcutIconUpload.js
  function initAppShortcutIconUpload() {
  ...
  function handleAppShortcutIconUpload() {
    ...
    settingAppShortcuts.on("click", "[data-file-upload]", function(e) {
      e.preventDefault();
      const self2 = jQuery(this);
      const attachmentPlaceholder = self2.find("[data-attachment-placeholder]");
      const attachmentHolder = self2.find("[data-attachment-holder]");
      const appShortcutIconInput = self2.find('input[type="text"]');
  ...
  function populateInitialShortcutIcons() {
    ...
    elements.each(function(index, el) {
      ...
      JSON.parse(JSON.stringify(config.jsVars.settings), (key, value) => {
        var _a;
        if (key === "appShortcuts") {
          imageID = (_a = value[index]) == null ? void 0 : _a.icon;
        }
        return value;
      });
      if (imageID) {
  ...
  // admin/assets/js/dev/modules/appScreenshotsUpload.js
  var { __: __2 } = wp.i18n;
  function initAppScreenshotsUpload() {
    handleAppScreenshotsUpload();
  }
  function handleAppScreenshotsUpload() {
    var _a, _b, _c, _d;
    ...
    const maxFiles = 5;
    const defaultScreenshots = [`https://s0.wp.com/mshots/v1/${config.jsVars.homeUrl + ((_b = (_a = config.jsVars.settings.webAppManifest) == null ? void 0 : _a.displaySettings) == null ? void 0 : _b.startPagePath)}?vpw=750&vph=1334&format=png`, `https://s0.wp.com/mshots/v1/${config.jsVars.homeUrl + ((_d = (_c = config.jsVars.settings.webAppManifest) == null ? void 0 : _c.displaySettings) == null ? void 0 : _d.startPagePath)}?vpw=1280&vph=800&format=png`];
    function initializeScreenshots() {
      var _a2, _b2;
      const savedScreenshots = ((_b2 = (_a2 = config.jsVars.settings.webAppManifest) == null ? void 0 : _a2.appIdentity) == null ? void 0 : _b2.appScreenshots) || [];
      screenshotsContainer.empty();
      if (savedScreenshots.length === 0) {
        addDefaultScreenshots();
      } else {
        const promises = savedScreenshots.map(
          (attachmentId) => fetchAttachmentUrl(attachmentId).then((url) => {
            if (url) {
    ...
    function updateInputFields() {
      ...
      if (index === 0) {
        const inputField = jQuery("<input>", {
          ...
          value: ""
          // Empty value to represent an empty array
        });
        screenshotsContainer.after(inputField);
      }
    }
    appScreenshotsUploadBtn.on("click", function(e) {
      e.preventDefault();
      let frame = wp.media({
        title: __2("Select or upload App Screenshots", config.jsVars.slug),
        button: {
          text: __2("Select Screenshots", config.jsVars.slug)
        },
        multiple: true
      });
      frame.on("select", function() {
    ...
    function createScreenshotElement(imgSrc, attachmentId, isDefault = false) {
      const uniqueId = "dismiss-img" + Date.now() + Math.floor(Math.random() * 1e3);
  ...
  // admin/assets/js/dev/modules/customCssJsEditor.js
  function initCustomCssJsEditor() {
  ...
  // admin/assets/js/dev/modules/pushImageUpload.js
  var { __: __3 } = wp.i18n;
  function initPushImageUpload() {
    handlePushImageUpload();
  }
  function handlePushImageUpload() {
    ...
    pushImageUploadBtn.on("click", function(e) {
      ...
      frame = wp.media({
        title: __3("Select or upload a notification image", config.jsVars.slug),
        button: {
          text: __3("Select Notification Image", config.jsVars.slug)
        },
        multiple: false
      });
      frame.on("select", function() {
  ...
  // admin/assets/js/dev/modules/pushSubscribers.js
  var { __: __4 } = wp.i18n;
  var SubscriberManager = class {
    ...
    setupEventListeners() {
      var _a, _b;
      (_a = this.prevBtn) == null ? void 0 : _a.addEventListener("click", () => this.handlePageChange("prev"));
      (_b = this.nextBtn) == null ? void 0 : _b.addEventListener("click", () => this.handlePageChange("next"));
    ...
    updateSubscribersList(data) {
            ...
            <div class="p-5 min-h-56 flex flex-col justify-center items-center text-center">
              ...
              <div class="max-w-sm mx-auto">
                <p class="mt-2 text-base font-medium text-gray-800">
                  ${__4("No Subscribers", config.jsVars.slug)}
                </p>
                <p class="text-sm text-gray-500">
                  ${__4("There are no push notification subscribers yet.", config.jsVars.slug)}
                </p>
              </div>
            </div>
          </td>
      ...
      `;
        ...
        (_a = this.thead) == null ? void 0 : _a.classList.add("hidden");
        (_b = this.pagination) == null ? void 0 : _b.classList.remove("inline-flex");
        (_c = this.pagination) == null ? void 0 : _c.classList.add("hidden");
        (_d = this.sendNotificationButton) == null ? void 0 : _d.classList.remove("inline-flex");
        (_e = this.sendNotificationButton) == null ? void 0 : _e.classList.add("hidden");
        return;
      }
      this.tbody.innerHTML = data.subscribers.map((sub) => this.createSubscriberRow(sub)).join("");
      (_f = this.thead) == null ? void 0 : _f.classList.remove("hidden");
      (_g = this.sendNotificationButton) == null ? void 0 : _g.classList.remove("hidden");
      (_h = this.sendNotificationButton) == null ? void 0 : _h.classList.add("inline-flex");
    ...
    updatePagination(data) {
      ...
      if (this.totalPages > 1) {
        (_a = this.pagination) == null ? void 0 : _a.classList.remove("hidden");
        (_b = this.pagination) == null ? void 0 : _b.classList.add("inline-flex");
      } else {
        (_c = this.pagination) == null ? void 0 : _c.classList.add("hidden");
        (_d = this.pagination) == null ? void 0 : _d.classList.remove("inline-flex");
      }
    ...
    async removeSubscriber(endpoint) {
      if (!confirm(__4("Are you sure you want to remove this subscriber?", config.jsVars.slug))) return;
      try {
        this.isLoading = true;
  ...
  // admin/assets/js/dev/modules/modalPushNotifications.js
  function initModalPushNotifications() {
  ...
  function previewPushNotification(e) {
    e.preventDefault();
    const form = utils_default(e.target).closest("form");
  ...
  // admin/assets/js/dev/modules/generateMobileApps.js
  function initGenerateMobileApps() {
    const paypalContainers = config.daftplugAdminElm.find(".paypalButtonsContainer");
    paypalContainers.each(function(e) {
      const self2 = jQuery(this);
      const productName = self2.attr("data-product-name");
      const price = self2.attr("data-price");
      const buttonColor = self2.attr("data-button-color");
      initPayPalButton(self2, productName, price, buttonColor);
    });
  }
    ...
    paypal.Buttons({
      ...
      onApprove: function(data, actions) {
        return actions.order.capture().then(function(orderData) {
          ...
          paypalResponse.css({
            ...
            marginTop: "10px",
            color: "#fff"
          }).html(wp.i18n.__("Thank you for the payment! We are starting to create apps for you and will send it to you soon.", config.jsVars.slug)).fadeIn("fast");
          setTimeout(function() {
      ...
      onError: function(err) {
        ...
        paypalResponse.css({
          ...
          marginTop: "10px",
          color: "#fff"
        }).html(wp.i18n.__("Payment failed! Please try again or contact us on support@daftplug.com", config.jsVars.slug)).fadeIn("fast");
        setTimeout(function() {
          paypalResponse.fadeOut("fast", function() {
            paypalButtons.fadeIn("fast");
          });
  ...
  // admin/assets/js/dev/modules/supportRequest.js
  ...
  // admin/assets/js/dev/modules/changelog.js
  ...
  var initializedModules = /* @__PURE__ */ new Set();
  var coreModules = [
  ...
  var initializeModules = () => {
    ...
    if (!isActivationPage && !currentHash.startsWith("#/error")) {
      commonModules.forEach((module2) => {
        if (!initializedModules.has(module2.name)) {
          module2.init();
          initializedModules.add(module2.name);
        }
      });
    }
    coreModules.forEach((module2) => {
      if (!initializedModules.has(module2.name)) {
        module2.init();
        initializedModules.add(module2.name);
      }
