<!-- ========== MAIN CONTENT ========== -->
<main id="content" class="flex flex-col w-full bg-gray-50 dark:bg-neutral-900 rounded-xl xl:ps-[250px] pt-[59px] absolute top-0 h-[calc(100svh-32px)] overflow-y-auto">
