<!-- ========== MAIN CONTENT ========== -->
<main id="content" class="flex flex-col w-full bg-gray-50 dark:bg-neutral-900 rounded-xl xl:ps-[260px] pt-[59px] absolute top-0 h-[calc(100svh-100px)] overflow-y-auto">
