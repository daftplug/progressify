...
<!-- ========== HEADER ========== -->
<header class="lg:ms-[260px] absolute top-0 rounded-t-xl inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
