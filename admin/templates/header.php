...
<header class="xl:ms-[260px] absolute top-0 rounded-tr-xl inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
  <div class="flex justify-between xl:grid xl:grid-cols-3 basis-full items-center w-full py-2.5 px-2 sm:px-5" aria-label="Global">
    <div class="xl:col-span-1 flex items-center md:gap-x-3">
      ...
      <div id="searchComboBox" class="relative hidden xl:block min-w-96 xl:w-full" data-hs-combo-box='{
          "groupingType": "default",
          "preventSelection": true,
          "isOpenOnFocus": true,
          "outputEmptyTemplate": "<div class=\"py-2 px-4 w-full text-sm text-gray-800 rounded-lg dark:bg-neutral-900 dark:text-neutral-200\"><?php esc_html_e('No Results...', $this->slug); ?></div>",
        ...
        <div class="hidden absolute z-50 w-full bg-white rounded-xl shadow-2xl dark:bg-neutral-800" data-hs-combo-box-output="">
          <div class="max-h-[400px] p-2 overflow-y-auto overflow-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500" data-hs-combo-box-output-items-wrapper="">
            <div data-hs-combo-box-output-item='{"group": {"name": "publish-on-app-stores", "title": "Publish to App Stores"}}' tabindex="4">
              <div class="py-2 px-2.5 flex items-center cursor-pointer gap-x-2 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-navigate-to-page="publishToAppStores">
            ...
            <div data-hs-combo-box-output-item='{"group": {"name": "publish-on-app-stores", "title": "Publish to App Stores"}}' tabindex="5">
              <div class="py-2 px-2.5 flex items-center cursor-pointer gap-x-2 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-navigate-to-page="publishToAppStores">
                <div class="relative inline-block shrink-0">
            ...
            <div data-hs-combo-box-output-item='{"group": {"name": "publish-on-app-stores", "title": "Publish to App Stores"}}' tabindex="6">
              <div class="py-2 px-2.5 flex items-center cursor-pointer gap-x-2 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-navigate-to-page="publishToAppStores">
                <div class="relative inline-block shrink-0">
      ...
      <div class="flex items-center gap-x-2">
        ...
        <a class="w-full flex items-center gap-x-2 py-2 px-3 rounded-lg bg-gradient-to-r from-green-600 to-blue-600" href="#/publishToAppStores/">
          ...
          <span class="text-xs text-transparent font-medium text-white">
            <?php _e('Publish to App Stores', $this->slug); ?>
          </span>
        </a>
      </div>
    </div>
