...
<!-- ========== HEADER ========== -->
<header class="xl:ms-[260px] absolute top-0 rounded-t-xl inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
  <div class="flex justify-between xl:grid xl:grid-cols-3 basis-full items-center w-full py-2.5 px-2 sm:px-5" aria-label="Global">
    ...
    <div class="xl:col-span-2 flex justify-end items-center gap-x-2">
      <div class="flex items-center gap-x-2">
        ...
        <a class="w-full flex items-center gap-x-2 py-2 px-3 rounded-lg bg-gradient-to-tl from-blue-600 to-green-600" href="#/publishOnAppStores/" data-page-id="publishOnAppStores">
