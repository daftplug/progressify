  ...
  <div class="flex justify-between xl:grid xl:grid-cols-3 basis-full items-center w-full py-2.5 px-2 sm:px-5" aria-label="Global">
        ...
        <div class="dp-searchbox-output hidden absolute mt-2 z-50 w-full bg-white rounded-xl shadow-2xl dark:bg-neutral-800">
          <div class="dp-searchbox-output-wrapper max-h-[400px] p-2 overflow-y-auto overflow-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            <div class="dp-searchbox-group">
              <div class="dp-searchbox-item-group-title block text-xs text-gray-500 m-3 mb-1 dark:text-neutral-500 dark:border-neutral-700"><?php esc_html_e('Publish to App Stores', $this->slug); ?></div>
              <div class="dp-searchbox-item py-2 px-2.5 flex items-center cursor-pointer gap-x-2 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-navigate-to-page="publishToAppStores">
                <div class="relative inline-block shrink-0">
                  <img class="size-4" src="<?php echo esc_url(plugins_url('admin/assets/media/icons/app-stores/play-store.png', $this->pluginFile)); ?>" alt="<?php echo esc_attr__('Play Store', $this->slug); ?>" />
                  <div class="absolute -bottom-0.5 -right-0.5 size-2 inline-block border border-gray-200 bg-white p-px shrink-0 rounded-full">
                    <img class="size-full" src="<?php echo esc_url(plugins_url('admin/assets/media/icons/operating-systems/android.png', $this->pluginFile)); ?>" alt="<?php echo esc_attr__('Android', $this->slug); ?>" />
                  </div>
                </div>
                <span class="dp-searchbox-item-title text-sm truncate text-gray-800 dark:text-neutral-200">Google Play Store</span>
              </div>
              <div class="dp-searchbox-item py-2 px-2.5 flex items-center cursor-pointer gap-x-2 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-navigate-to-page="publishToAppStores">
                <div class="relative inline-block shrink-0">
                  <img class="size-4" src="<?php echo esc_url(plugins_url('admin/assets/media/icons/app-stores/app-store.png', $this->pluginFile)); ?>" alt="<?php echo esc_attr__('App Store', $this->slug); ?>" />
                  <div class="absolute -bottom-0.5 -right-0.5 size-2 inline-block border border-gray-200 bg-white p-px shrink-0 rounded-full">
                    <img class="size-full" src="<?php echo esc_url(plugins_url('admin/assets/media/icons/operating-systems/mac.png', $this->pluginFile)); ?>" alt="<?php echo esc_attr__('Mac', $this->slug); ?>" />
                  </div>
                </div>
                <span class="dp-searchbox-item-title text-sm truncate text-gray-800 dark:text-neutral-200">Apple App Store</span>
              </div>
              <div class="dp-searchbox-item py-2 px-2.5 flex items-center cursor-pointer gap-x-2 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" data-navigate-to-page="publishToAppStores">
                <div class="relative inline-block shrink-0">
                  <img class="size-4" src="<?php echo esc_url(plugins_url('admin/assets/media/icons/app-stores/microsoft-store.png', $this->pluginFile)); ?>" alt="<?php echo esc_attr__('Microsoft Store', $this->slug); ?>" />
                  <div class="absolute -bottom-0.5 -right-0.5 size-2 inline-block border border-gray-200 bg-white p-px shrink-0 rounded-full">
                    <img class="size-full" src="<?php echo esc_url(plugins_url('admin/assets/media/icons/operating-systems/windows.png', $this->pluginFile)); ?>" alt="<?php echo esc_attr__('Windows', $this->slug); ?>" />
                  </div>
                </div>
                <span class="dp-searchbox-item-title text-sm truncate text-gray-800 dark:text-neutral-200">Microsoft Store</span>
              </div>
            </div>
    ...
    <div class="xl:col-span-2 flex justify-end items-center gap-x-2">
      <div class="flex items-center gap-x-2">
        <a class="w-full flex items-center gap-x-2 py-2 px-3 rounded-lg bg-gradient-to-r from-green-600 to-blue-600" href="#/publishToAppStores/">
