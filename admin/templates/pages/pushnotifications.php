    ...
    <div class="col-span-full xl:col-span-7 ml-11 xl:m-0 space-y-6" data-dp-dependant-markup='{
      ...
      <div id="settingPushButtonPosition">
        ...
        <select name="pushNotifications[button][position]" required="true" data-dp-select='{
          ...
          <option value="top-left" <?php selected(Plugin::getSetting('pushNotifications[button][position]'), 'top-left'); ?>><?php esc_html_e('Top Left', $this->textDomain); ?></option>
        </select>
      </div>
      <!-- End Button Position -->
      <!-- Button Behavior -->
    ...
    <div class="col-span-full xl:col-span-7 ml-11 xl:m-0 space-y-6" data-dp-dependant-markup='{
          ...
          <div class="flex justify-between items-center">
            <div class="relative inline-block">
              <input type="checkbox" id="pushNotifications[automation][woocommerce][newProduct]" name="pushNotifications[automation][woocommerce][newProduct]" class="relative w-11 h-6 !p-px bg-gray-100 !border-transparent !border text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-blue-600 data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none checked:bg-none checked:text-blue-600 checked:border-blue-600 focus:checked:border-blue-600 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-neutral-900 before:inline-block before:!size-5 before:bg-white checked:before:bg-white checked:before:m-0 before:translate-x-0 checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-white text-start" <?php checked(
                Plugin::getSetting('pushNotifications[automation][woocommerce][newProduct]'),
                'on'
              ); ?>>
            </div>
          </div>
      ...
      <div id="settingPushAbandonedCart" class="relative bg-white border border-gray-200 rounded-xl shadow-sm py-2 px-3 dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div class="mt-4" data-dp-dependant-markup='{
          ...
          <select name="pushNotifications[automation][wordpress][abandonedCart][interval]" required="true" data-dp-select='{
            ...
            <option value="4" <?php selected('4', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 4 hours', $this->textDomain); ?></option>
            <option value="5" <?php selected('5', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 5 hours', $this->textDomain); ?></option>
            <option value="6" <?php selected('6', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 6 hours', $this->textDomain); ?></option>
            <option value="7" <?php selected('7', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 7 hours', $this->textDomain); ?></option>
            <option value="8" <?php selected('8', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 8 hours', $this->textDomain); ?></option>
            <option value="9" <?php selected('9', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 9 hours', $this->textDomain); ?></option>
            <option value="10" <?php selected('10', Plugin::getSetting('pushNotifications[automation][wordpress][abandonedCart][interval]')); ?>><?php esc_html_e('Every 10 hours', $this->textDomain); ?></option>
          </select>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div id="settingPushWooOrderStatusUpdate" class="relative bg-white border border-gray-200 rounded-xl shadow-sm py-2 px-3 dark:bg-neutral-800 dark:border-neutral-700">
        <label for="pushNotifications[automation][woocommerce][orderStatusUpdate][feature]" class="cursor-pointer flex gap-x-3">
          ...
          <div class="flex justify-between items-center">
            <div class="relative inline-block">
              <input type="checkbox" id="pushNotifications[automation][woocommerce][orderStatusUpdate][feature]" name="pushNotifications[automation][woocommerce][orderStatusUpdate][feature]"
      ...
      <div id="settingPushWooLowStock" class="relative bg-white border border-gray-200 rounded-xl shadow-sm py-2 px-3 dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div class="mt-4" data-dp-dependant-markup='{
          ...
          "max": 100
            ...
            <div class="w-full flex justify-between items-center gap-x-3">
              <input name="pushNotifications[automation][woocommerce][lowStock][threshold]" type="number" class="w-full p-0 bg-transparent border-0 focus:ring-0 text-xs" value="<?php echo Plugin::getSetting('pushNotifications[automation][woocommerce][lowStock][threshold]'); ?>" step="1" max="100" min="1" data-hs-input-number-input="">
              <div class="flex justify-end items-center gap-x-1.5">
      ...
      <div id="settingPushPeepso" class="relative bg-white border border-gray-200 rounded-xl shadow-sm py-2 px-3 dark:bg-neutral-800 dark:border-neutral-700">
        <label for="pushNotifications[automation][peepso][feature]" class="cursor-pointer flex gap-x-3">
          ...
          <div class="flex justify-between items-center">
            <div class="relative inline-block">
              <input type="checkbox" id="pushNotifications[automation][peepso][feature]" name="pushNotifications[automation][peepso][feature]" class="relative w-11 h-6 !p-px bg-gray-100 !border-transparent !border text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-blue-600 data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none checked:bg-none checked:text-blue-600 checked:border-blue-600 focus:checked:border-blue-600 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-neutral-900 before:inline-block before:!size-5 before:bg-white checked:before:bg-white checked:before:m-0 before:translate-x-0 checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-white text-start" <?php checked(
                Plugin::getSetting('pushNotifications[automation][peepso][feature]'),
                'on'
              ); ?>>
            </div>
          </div>
      ...
      <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-neutral-700">
        ...
        <button type="submit" class="group py-2 px-3 inline-flex justify-center items-center gap-x-2 text-start bg-blue-600 border border-blue-600 text-white text-sm font-medium rounded-lg shadow-sm align-middle hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-blue-300 dark:focus:ring-blue-500">
          <span class="hidden group-data-[sending=true]:inline-block animate-spin size-4 border-[3px] border-current border-t-transparent text-white rounded-full transition" role="status" aria-label="loading">
            <span class="sr-only"><?php _e('Sending...', $this->textDomain); ?></span>
          </span>
          <?php _e('Send Push Notification', $this->textDomain); ?>
        </button>
      </div>
