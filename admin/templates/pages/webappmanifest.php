    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-14 max-xl:space-y-7">
      ...
      <div class="xl:col-span-2 ml-11 xl:m-0 space-y-7">
        ...
        <div id="settingDescription">
          ...
          <textarea name="webAppManifest[appIdentity][description]" class="overflow-hidden resize-none shadow-sm py-2 px-3 block w-full border-gray-200 rounded-lg text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600" placeholder="<?php esc_html_e('Enter Description', $this->slug); ?>" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" rows="4" required><?php echo esc_attr(Plugin::getSetting('webAppManifest[appIdentity][description]')); ?></textarea>
        </div>
        <!-- End Description -->
        <!-- Categories -->
  ...
  <fieldset class="py-7 sm:py-10 first:pt-0 last-of-type:pb-0 border-t border-gray-200 first:border-t-0 dark:border-neutral-700" id="subsectionDisplaySettings">
    <div class="xl:grid xl:grid-cols-3 xl:gap-14 max-xl:space-y-7">
      ...
      <div class="xl:col-span-2 ml-11 xl:m-0 space-y-7">
        ...
        <!-- End Orientation -->
        <!-- Orientation Lock -->
        <div id="settingOrientationLock" class="relative bg-white border border-gray-200 rounded-xl shadow-sm py-2 px-3 dark:bg-neutral-800 dark:border-neutral-700">
            ...
            <div class="flex justify-between items-center">
              <div class="relative inline-block">
                <input type="checkbox" id="webAppManifest[displaySettings][orientationLock]" name="webAppManifest[displaySettings][orientationLock]" class="relative w-11 h-6 !p-px bg-gray-100 !border-transparent !border text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-blue-600 data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none checked:bg-none checked:text-blue-600 checked:border-blue-600 focus:checked:border-blue-600 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-neutral-900 before:inline-block before:!size-5 before:bg-white checked:before:bg-white checked:before:m-0 before:translate-x-0 checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-neutral-400 dark:checked:before:bg-white text-start" <?php checked(
                  Plugin::getSetting('webAppManifest[displaySettings][orientationLock]'),
                  'on'
                ); ?>>
              </div>
            </div>
    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-14 max-xl:space-y-7">
      ...
      <div class="xl:col-span-2 ml-11 xl:m-0 space-y-7">
        ...
        <div id="settingThemeColor">
          ...
          <input name="webAppManifest[appearance][themeColor]" type="color" class="p-1 h-[38px] w-full shadow-sm block bg-white border border-gray-200 cursor-pointer rounded-lg data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700" value="<?php echo esc_attr(Plugin::getSetting('webAppManifest[appearance][themeColor]')); ?>" title="<?php esc_html_e('Theme Color', $this->slug); ?>" required>
        </div>
        <!-- End Theme Color -->
        <!-- Background Color -->
