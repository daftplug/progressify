        ...
        <div class="flex items-start justify-between gap-x-4">
          <div class="flex items-center max-w-[70%] gap-x-2">
            ...
            <div class="space-y-0.5">
              <h3 class="text-base font-semibold text-gray-800 dark:text-white line-clamp-1 empty:bg-gray-300 empty:rounded-full empty:h-1.5 empty:w-20"><?php echo esc_html(Plugin::getSetting('webAppManifest[appIdentity][appName]')); ?></h3>
