    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-14 max-xl:space-y-7">
      ...
      "mode": "availability"
        ...
        <div id="settingCacheExpirationTime">
          ...
          <input name="offlineUsage[cache][expirationTime]" type="number" class="shadow-sm py-2 px-3 block w-full border-gray-200 rounded-lg text-sm placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 data-[disabled=true]:opacity-50 data-[disabled=true]:pointer-events-none dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:placeholder:text-white/60 dark:focus:ring-neutral-600 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" value="<?php echo esc_attr(Plugin::getSetting('offlineUsage[cache][expirationTime]')); ?>" step="1" max="10" min="1" required="true">
        </div>
