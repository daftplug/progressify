    ...
    "frontend/assets/js/dev/modules/installOverlayHeaderBanner.js"() {
      ...
      PwaInstallOverlayHeaderBanner = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const bannerTitle = config.jsVars.settings.installation?.prompts?.text ?? __2("Install Web App", config.jsVars.slug);
      ...
      <div class="header-banner-overlay">
        <div class="header-banner-overlay-appinfo">
          ...
          <div class="header-banner-overlay-appinfo_texts">
            ...
            <div class="header-banner-overlay-appinfo_description">${__2("Get our web app. It won't take up space on your device.", config.jsVars.slug)}</div>
          </div>
        </div>
        <div class="header-banner-overlay-buttons">
          <button type="button" class="header-banner-overlay-button_install">
            ${__2("Install Now", config.jsVars.slug)}
          </button>
    ...
    "frontend/assets/js/dev/modules/installOverlaySnackbar.js"() {
      ...
      PwaInstallOverlaySnackbar = class extends HTMLElement {
        ...
        render() {
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const snackbarTitle = config.jsVars.settings.installation?.prompts?.text ?? __2("Install Web App", config.jsVars.slug);
          this.injectStyles(`
      .snackbar-overlay {
        display: flex;
        align-items: center;
    ...
    `);
      ...
      <div class="snackbar-overlay">
        <div class="snackbar-overlay-appinfo">
          ...
          <div class="snackbar-overlay-appinfo_description">${__2("Installing uses no storage and offers a quick way back to our web app.", config.jsVars.slug)}</div>
        </div>
      ...
      <div class="blog-popup-overlay">
        <div class="blog-popup-overlay-container">
          <div class="blog-popup-overlay-header">
            <div class="blog-popup-overlay-header_title">${__2("Read this article in our web app", config.jsVars.slug)}</div>
          </div>
          <div class="blog-popup-overlay-body">
            ...
            <div class="blog-popup-overlay-browserinfo">
              ...
              <button type="button" class="blog-popup-overlay-button -continue">
                ${__2("Continue", config.jsVars.slug)}
              </button>
            </div>     
          </div>
        </div>
      ...
      <div class="navigation-menu-overlay">
        <div class="navigation-menu-overlay-appinfo">
          ...
          <div class="navigation-menu-overlay-appinfo_texts">
            ...
            <div class="navigation-menu-overlay-appinfo_description">${__2("Find what you need faster by installing our web app!", config.jsVars.slug)}</div>
          </div>
        </div>
      ...
      <div class="in-feed-overlay">
        <div class="in-feed-overlay-appinfo">
          ...
          <div class="in-feed-overlay-appinfo_texts">
            ...
            <div class="in-feed-overlay-appinfo_description">${__2("Keep reading, even when you're on the train!", config.jsVars.slug)}</div>
          </div>
        </div>
      ...
      <div class="woocommerce-checkout-overlay">
        <div class="woocommerce-checkout-overlay-appinfo">
          ...
          <div class="woocommerce-checkout-overlay-appinfo_texts">
            ...
            <div class="woocommerce-checkout-overlay-appinfo_description">${__2("Keep track of your orders. Our web app is fast, small and works offline.", config.jsVars.slug)}</div>
          </div>
        </div>
      ...
      PwaOfflineNotification = class extends HTMLElement {
        ...
        static showReconnecting() {
          ...
          requestAnimationFrame(() => {
            ...
            text.textContent = __2("Connection lost. Attempting to reconnect...", config.jsVars.slug);
            setTimeout(() => {
        ...
        static showReconnected() {
          ...
          text.textContent = __2("Successfully reconnected to the internet!", config.jsVars.slug);
    ...
    `);
      ...
      <div class="offline-notification" role="alert" tabindex="-1">
        ...
        <span class="offline-notification_text">
          ${__2("Connection lost. Attempting to reconnect...", config.jsVars.slug)}
        </span>
      </div>
    `;
        }
        ...
        <div class="offline-form-handler-container">
          <div class="offline-form-handler-header">
            <div class="offline-form-handler-header-texts">
              ...
              <div class="offline-form-handler-header-texts_title">${__2("No Internet Connection", config.jsVars.slug)}</div>
            </div>
          </div>
          <div class="offline-form-handler-body">
            <div class="offline-form-handler-body_message">${__2("You\u2019re currently offline. Your form submission data will be saved and be automatically processed in the background when you\u2019re back online within 24 hours. Would you like to proceed?", config.jsVars.slug)}</div>
          </div>
      ...
      PwaPullDownRefresh = class extends HTMLElement {
        ...
        handleTouchMove(e) {
          ...
          if (pullDistance >= 0) {
            ...
            if (pullDistance > this.threshold) {
              statusText.textContent = __2("Release to refresh", config.jsVars.slug);
            } else {
              statusText.textContent = __2("Pull down to refresh", config.jsVars.slug);
            }
          }
        }
        async handleTouchEnd() {
          ...
          if (pullDistance > this.threshold) {
            ...
            statusText.textContent = __2("Refreshing...", config.jsVars.slug);
      ...
      <div class="pull-down-refresh" role="alert">
        <div class="pull-down-refresh_content">
          ...
          <span class="pull-down-refresh_text">
            ${__2("Pull down to refresh", config.jsVars.slug)}
          </span>
        </div>
      </div>
    `;
    ...
    `);
      ...
      <div class="shake-notification" role="alert">
        ...
        <span class="shake-notification_text">
          ${__2("Shake detected! Refreshing the page...", config.jsVars.slug)}
        </span>
      </div>
    `;
        }
    ...
    `);
          ...
          switch (true) {
            case config.jsVars.pageData.type.isHome:
              message = __2("Homepage Opened", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.is404:
              message = __2("Page Not Found", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isSearch:
              message = __2("Search Results", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isBlogPost:
              message = __2("Article Opened", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isWooShop:
              message = __2("Shop Opened", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isWooProduct:
              message = __2("Product Opened", config.jsVars.slug);
              break;
            default:
              message = __2("Page Opened", config.jsVars.slug);
              break;
          }
          const combinedStyles = Array.from(this.styles).join("\n");
          this.shadowRoot.innerHTML = `
      ...
      <div class="idle-notification" role="alert" tabindex="-1">
        <div class="idle-notification_texts">
          ...
          <span class="idle-notification_text">
            ${__2("You've been idle for a while.", config.jsVars.slug)}
          </span>
        </div>
    ...
    "frontend/assets/js/dev/modules/pushNotificationsPrompt.js"() {
      ...
      PwaPushNotificationsPrompt = class _PwaPushNotificationsPrompt extends HTMLElement {
        ...
        render() {
          ...
          const backgroundColor = getContrastTextColor(themeColor);
          const textColor = getContrastTextColor(backgroundColor);
          const promptMessage = config.jsVars.settings.pushNotifications?.prompt?.message ?? __2("We would like to show you notifications for the latest news and updates.", config.jsVars.slug);
          const appName = config.jsVars.settings.webAppManifest.appIdentity.appName ?? "";
      ...
      <div class="push-notifications-prompt">
        <div class="push-notifications-prompt-media">
          ...
          <div class="push-notifications-prompt-media_texts">
            <div class="push-notifications-prompt-media_title">${__2("Push Notifications", config.jsVars.slug)}</div>
        ...
        <div class="push-notifications-prompt-buttons">
          <button type="button" class="push-notifications-prompt-button_dismiss">
            ${__2("Dismiss", config.jsVars.slug)}
          </button>
          <button type="button" class="push-notifications-prompt-button_allow">
            ${__2("Allow Notifications", config.jsVars.slug)}
          </button>
        </div>
      </div>
    `;
