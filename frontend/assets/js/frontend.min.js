(() => {
  ...
  var __2, deferredInstallPrompt, svg, PwaInstallPrompt;
    ...
    "frontend/assets/js/dev/modules/installButton.js"() {
      ...
      PwaInstallButton = class extends HTMLElement {
        ...
        render() {
          const themeColor = config2.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const buttonText = config2.jsVars.settings.installation?.prompts?.text ?? __("Install Web App", config2.jsVars.slug);
          this.injectStyles(`
      :host(:active),
      :host(:focus) {
        outline: transparent;
  ...
  var __3, PwaInstallOverlayHeaderBanner;
    ...
    "frontend/assets/js/dev/modules/installOverlayHeaderBanner.js"() {
      ...
      PwaInstallOverlayHeaderBanner = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config2.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config2.jsVars.settings.installation?.prompts?.text ?? __3("Install Web App", config2.jsVars.slug);
          const message = config2.jsVars.settings.installation?.prompts?.types?.headerBanner?.message ?? __3("Get our web app. It won't take up space on your device.", config2.jsVars.slug);
      ...
      <div class="header-banner-overlay">
        ...
        <div class="header-banner-overlay-buttons">
          <button type="button" class="header-banner-overlay-button_install">
            ${__3("Install Now", config2.jsVars.slug)}
          </button>
  ...
  var __4, PwaInstallOverlaySnackbar;
    ...
    "frontend/assets/js/dev/modules/installOverlaySnackbar.js"() {
      ...
      PwaInstallOverlaySnackbar = class extends HTMLElement {
        ...
        render() {
          const themeColor = config2.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config2.jsVars.settings.installation?.prompts?.text ?? __4("Install Web App", config2.jsVars.slug);
          const message = config2.jsVars.settings.installation?.prompts?.types?.snackbar?.message ?? __4("Installing uses no storage and offers a quick way back to our web app.", config2.jsVars.slug);
          this.injectStyles(`
      .snackbar-overlay {
        display: flex;
        align-items: center;
    ...
    `);
      ...
      <div class="snackbar-overlay">
        ...
        <button type="button" class="snackbar-overlay-button_install">
          ${__4("Install Now", config2.jsVars.slug)}
        </button>
  ...
  var __5, PwaInstallOverlayBlogPopup;
      ...
      <div class="blog-popup-overlay">
        <div class="blog-popup-overlay-container">
          <div class="blog-popup-overlay-header">
            <div class="blog-popup-overlay-header_title">${__5("Read this article in our web app", config2.jsVars.slug)}</div>
          </div>
          <div class="blog-popup-overlay-body">
            ...
            <div class="blog-popup-overlay-browserinfo">
              ...
              <button type="button" class="blog-popup-overlay-button -continue">
                ${__5("Continue", config2.jsVars.slug)}
              </button>
            </div>     
          </div>
        </div>
  ...
  var __6, PwaInstallOverlayNavigationMenu;
    ...
    "frontend/assets/js/dev/modules/installOverlayNavigationMenu.js"() {
      ...
      PwaInstallOverlayNavigationMenu = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config2.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config2.jsVars.settings.installation?.prompts?.text ?? __6("Install Web App", config2.jsVars.slug);
          const message = config2.jsVars.settings.installation?.prompts?.types?.navigationMenu?.message ?? __6("Find what you need faster by installing our web app!", config2.jsVars.slug);
    ...
    `);
      ...
      <div class="navigation-menu-overlay">
        ...
        <button type="button" class="navigation-menu-overlay-button_install">
          ${__6("Install Now", config2.jsVars.slug)}
        </button>
      </div>
    `;
        }
  ...
  var __7, PwaInstallOverlayInFeed;
    ...
    "frontend/assets/js/dev/modules/installOverlayInFeed.js"() {
      ...
      PwaInstallOverlayInFeed = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config2.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config2.jsVars.settings.installation?.prompts?.text ?? __7("Install Web App", config2.jsVars.slug);
          const message = config2.jsVars.settings.installation?.prompts?.types?.inFeed?.message ?? __7("Keep reading, even when you're on the train!", config2.jsVars.slug);
    ...
    `);
      ...
      <div class="in-feed-overlay">
        ...
        <button type="button" class="in-feed-overlay-button_install">
          ${__7("Install Now", config2.jsVars.slug)}
        </button>
      </div>
    `;
        }
  ...
  var __8, PwaInstallOverlayWoocommerceCheckout;
    ...
    "frontend/assets/js/dev/modules/installOverlayWoocommerceCheckout.js"() {
      ...
      PwaInstallOverlayWoocommerceCheckout = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config2.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config2.jsVars.settings.installation?.prompts?.text ?? __8("Install Web App", config2.jsVars.slug);
          const message = config2.jsVars.settings.installation?.prompts?.types?.woocommerceCheckout?.message ?? __8("Keep track of your orders. Our web app is fast, small and works offline.", config2.jsVars.slug);
    ...
    `);
      ...
      <div class="woocommerce-checkout-overlay">
        ...
        <button type="button" class="woocommerce-checkout-overlay-button_install">
          ${__8("Install Now", config2.jsVars.slug)}
        </button>
      </div>
    `;
        }
  ...
  var __9, PwaOfflineNotification;
      ...
      PwaOfflineNotification = class extends HTMLElement {
        ...
        static showReconnecting() {
          ...
          requestAnimationFrame(() => {
            ...
            text.textContent = __9("Connection lost. Attempting to reconnect...", config2.jsVars.slug);
            setTimeout(() => {
        ...
        static showReconnected() {
          ...
          text.textContent = __9("Successfully reconnected to the internet!", config2.jsVars.slug);
    ...
    `);
      ...
      <div class="offline-notification" role="alert" tabindex="-1">
        ...
        <span class="offline-notification_text">
          ${__9("Connection lost. Attempting to reconnect...", config2.jsVars.slug)}
        </span>
      </div>
    `;
        }
  ...
  var __10, PwaOfflineFormHandler;
        ...
        <div class="offline-form-handler-container">
          <div class="offline-form-handler-header">
            <div class="offline-form-handler-header-texts">
              ...
              <div class="offline-form-handler-header-texts_title">${__10("No Internet Connection", config2.jsVars.slug)}</div>
            </div>
          </div>
          <div class="offline-form-handler-body">
            <div class="offline-form-handler-body_message">${__10("You\u2019re currently offline. Your form submission data will be saved and be automatically processed in the background when you\u2019re back online within 24 hours. Would you like to proceed?", config2.jsVars.slug)}</div>
          </div>
  ...
  var init_darkMode = __esm({
    ...
    `);
          return `
      <div class="dark-mode-menu ${this.darkMode ? "-dark" : ""}" aria-label="${__11("Toggle dark mode")}">
    ...
    `);
          return `
      <div class="dark-mode-floating" aria-label="${__11("Toggle dark mode")}">
      ...
      PwaPullDownRefresh = class extends HTMLElement {
        ...
        handleTouchMove(e) {
          ...
          if (pullDistance >= 0) {
            ...
            if (pullDistance > this.threshold) {
              statusText.textContent = __12("Release to refresh", config2.jsVars.slug);
            } else {
              statusText.textContent = __12("Pull down to refresh", config2.jsVars.slug);
            }
          }
        }
        async handleTouchEnd() {
          ...
          if (pullDistance > this.threshold) {
            ...
            statusText.textContent = __12("Refreshing...", config2.jsVars.slug);
      ...
      <div class="pull-down-refresh" role="alert">
        <div class="pull-down-refresh_content">
          ...
          <span class="pull-down-refresh_text">
            ${__12("Pull down to refresh", config2.jsVars.slug)}
          </span>
        </div>
      </div>
    `;
    ...
    `);
      ...
      <div class="shake-notification" role="alert">
        ...
        <span class="shake-notification_text">
          ${__13("Shake detected! Refreshing the page...", config2.jsVars.slug)}
        </span>
      </div>
    `;
        }
    ...
    `);
          ...
          switch (true) {
            case config2.jsVars.pageData.type.isHome:
              message = __14("Homepage Opened", config2.jsVars.slug);
              break;
            case config2.jsVars.pageData.type.is404:
              message = __14("Page Not Found", config2.jsVars.slug);
              break;
            case config2.jsVars.pageData.type.isSearch:
              message = __14("Search Results", config2.jsVars.slug);
              break;
            case config2.jsVars.pageData.type.isBlogPost:
              message = __14("Article Opened", config2.jsVars.slug);
              break;
            case config2.jsVars.pageData.type.isWooShop:
              message = __14("Shop Opened", config2.jsVars.slug);
              break;
            case config2.jsVars.pageData.type.isWooProduct:
              message = __14("Product Opened", config2.jsVars.slug);
              break;
            default:
              message = __14("Page Opened", config2.jsVars.slug);
              break;
          }
          const combinedStyles = Array.from(this.styles).join("\n");
          this.shadowRoot.innerHTML = `
      ...
      <div class="idle-notification" role="alert" tabindex="-1">
        <div class="idle-notification_texts">
          ...
          <span class="idle-notification_text">
            ${__15("You've been idle for a while.", config2.jsVars.slug)}
          </span>
        </div>
  ...
  var __16, PwaPushNotificationsPrompt;
    ...
    "frontend/assets/js/dev/modules/pushNotificationsPrompt.js"() {
      ...
      PwaPushNotificationsPrompt = class _PwaPushNotificationsPrompt extends HTMLElement {
        ...
        render() {
          ...
          const backgroundColor = getContrastTextColor(themeColor);
          const textColor = getContrastTextColor(backgroundColor);
          const promptMessage = config2.jsVars.settings.pushNotifications?.prompt?.message ?? __16("We would like to show you notifications for the latest news and updates.", config2.jsVars.slug);
          const appName = config2.jsVars.settings.webAppManifest.appIdentity.appName ?? "";
      ...
      <div class="push-notifications-prompt">
        <div class="push-notifications-prompt-media">
          ...
          <div class="push-notifications-prompt-media_texts">
            <div class="push-notifications-prompt-media_title">${__16("Push Notifications", config2.jsVars.slug)}</div>
        ...
        <div class="push-notifications-prompt-buttons">
          <button type="button" class="push-notifications-prompt-button_dismiss">
            ${__16("Dismiss", config2.jsVars.slug)}
          </button>
          <button type="button" class="push-notifications-prompt-button_allow">
            ${__16("Allow Notifications", config2.jsVars.slug)}
          </button>
        </div>
      </div>
    `;
  ...
  var __17, PwaPushNotificationsButton;
  var init_pushNotificationsButton = __esm({
    ...
    `);
          ...
          this.shadowRoot.innerHTML = `
      <style>${combinedStyles}</style>
      <div class="push-notifications-button" aria-label="${__17("Enable / Disable Push Notifications")}">
