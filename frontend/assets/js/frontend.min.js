(() => {
  ...
  var init_installPrompt = __esm({
    ...
    `);
      ...
      <div class="install-prompt-loading">
        ...
        <div class="install-prompt-loading-text">${__2("Checking installation capabilities...", config.jsVars.slug)}</div>
      </div>
    `;
        }
    ...
    `);
          ...
          let btnIconSvg = "";
          let btnIconText = __2("Click to Install", config.jsVars.slug);
          if (device.isSmartphone || device.isTablet) {
            btnIconSvg = svg.installMobile;
            btnIconText = __2("Tap to Install", config.jsVars.slug);
    ...
    `);
          ...
          if (device.isSmartphone || device.isTablet) {
            if (os.isAndroid) {
              if (browser.isChrome) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three dots), located at the top-right of your screen.", config.jsVars.slug), svg.vertThreeDots);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option from the menu.', config.jsVars.slug), svg.addToHomeScreen);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" text on the browser installation dialog.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isFirefox) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three dots), located at the top-right of your screen.", config.jsVars.slug), svg.vertThreeDots);
                renderStep(__2('Select "Install"', config.jsVars.slug), __2('Tap the "Install" option from the menu.', config.jsVars.slug), svg.addToHomeScreen);
                renderStep(__2('Confirm by Tapping "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" button on the browser installation dialog.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isOpera) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three dots), located at the top-right of your screen.", config.jsVars.slug), svg.vertThreeDots);
                renderStep(__2('Select "Home Screen"', config.jsVars.slug), __2('Tap the "Install" option from the menu.', config.jsVars.slug), svg.installMobile);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" text on the browser installation dialog.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isEdge) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three horizontal lines) located at the bottom-right of your screen.", config.jsVars.slug), svg.hamburgerMenu);
                renderStep(__2('Select "Add to Phone"', config.jsVars.slug), __2('Tap the "Add to Phone" option from the menu', config.jsVars.slug), svg.installMobile);
                renderStep(__2('Confirm by Tapping "Install"', config.jsVars.slug), __2('Tap the "Install" text on the browser installation dialog.', config.jsVars.slug), svg.tapFinger);
              } else {
                renderStep(__2("Copy the Page URL", config.jsVars.slug), __2("Click the button below to copy the page's URL.", config.jsVars.slug), svg.copy, this.renderCopyInstallUrlButton());
                renderStep(__2("Open the Google Chrome Browser", config.jsVars.slug), __2("Launch the Google Chrome web browser from your home screen.", config.jsVars.slug), svg.googleChrome);
                renderStep(__2("Paste and Open the URL", config.jsVars.slug), __2("Paste the copied URL into Google Chrome's address bar and open the page.", config.jsVars.slug), svg.pasteGo);
              }
            } else if (os.isIos) {
              if (browser.isSafari) {
                renderStep(__2("Tap the Share Icon", config.jsVars.slug), __2("Tap the share icon located at the center-bottom of your screen.", config.jsVars.slug), svg.iosShare);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option, represented by the plus [+] icon.', config.jsVars.slug), svg.plusInBox);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" button at the top-right corner of your screen.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isChrome) {
                renderStep(__2("Tap the Share Icon", config.jsVars.slug), __2("Tap the share icon located at the top-right of your browser address bar.", config.jsVars.slug), svg.iosShare);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option, represented by the plus [+] icon.', config.jsVars.slug), svg.plusInBox);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" button at the top-right corner of your screen.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isFirefox) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three horizontal lines) located at the bottom-right of your screen.", config.jsVars.slug), svg.hamburgerMenu);
                renderStep(__2("Tap the Share Icon", config.jsVars.slug), __2("Tap the share icon in the dialog overlay that the browser opens.", config.jsVars.slug), svg.iosShare);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option, represented by the plus [+] icon.', config.jsVars.slug), svg.plusInBox);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" button at the top-right corner of your screen.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isOpera) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three dots), located at the bottom-right of your screen.", config.jsVars.slug), svg.vertThreeDots);
                renderStep(__2("Tap the Share Icon", config.jsVars.slug), __2("Tap the share icon located at the top of the dialog overlay that browser opens.", config.jsVars.slug), svg.upload);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option, represented by the plus [+] icon.', config.jsVars.slug), svg.plusInBox);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" button at the top-right corner of your screen.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isEdge) {
                renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three horizontal lines) located at the bottom-right of your screen.", config.jsVars.slug), svg.hamburgerMenu);
                renderStep(__2("Tap the Share Icon", config.jsVars.slug), __2("Tap the share icon in the dialog overlay that the browser opens.", config.jsVars.slug), svg.upload);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option, represented by the plus [+] icon.', config.jsVars.slug), svg.plusInBox);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" button at the top-right corner of your screen.', config.jsVars.slug), svg.tapFinger);
              } else if (browser.isDuckduckgo) {
                renderStep(__2("Tap the Share Icon", config.jsVars.slug), __2("Tap the share icon located at the right side of the browser's address bar.", config.jsVars.slug), svg.upload);
                renderStep(__2('Select "Add to Home Screen"', config.jsVars.slug), __2('Tap the "Add to Home Screen" option, represented by the plus [+] icon.', config.jsVars.slug), svg.plusInBox);
                renderStep(__2('Confirm by Tapping "Add"', config.jsVars.slug), __2('Tap the "Add" button at the top-right corner of your screen.', config.jsVars.slug), svg.tapFinger);
              } else {
                renderStep(__2("Copy the Page URL", config.jsVars.slug), __2("Click the button below to copy the page's URL.", config.jsVars.slug), svg.copy, this.renderCopyInstallUrlButton());
                renderStep(__2("Open the Safari Browser", config.jsVars.slug), __2("Launch the Safari web browser from your home screen.", config.jsVars.slug), svg.safari);
                renderStep(__2("Paste and Open the URL", config.jsVars.slug), __2("Paste the copied URL into Safari's address bar and open the page.", config.jsVars.slug), svg.pasteGo);
              }
            } else {
              renderStep(__2("Installation Not Supported", config.jsVars.slug), __2("Your operating system does not support web app installation. Please try accessing the website on an Android or iOS mobile device.", config.jsVars.slug), svg.noInstallSupport);
            }
          } else if (device.isDesktop) {
            if (browser.isChrome) {
              renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three dots) in the top-right corner of your browser window.", config.jsVars.slug), svg.vertThreeDots);
              renderStep(__2('Expand "Cast, save and share"', config.jsVars.slug), __2('Hover over the "Cast, Save, and Share" menu item to expand its options.', config.jsVars.slug), svg.fileSave);
              renderStep(__2('Select "Install page as app..."', config.jsVars.slug), __2('Click on "Install page as app..." from the menu.', config.jsVars.slug), svg.installDesktop);
              renderStep(__2('Confirm by Clicking "Install"', config.jsVars.slug), __2(`Click the "Install" button in the browser's installation dialog.`, config.jsVars.slug), svg.mouseClick);
            } else if (browser.isEdge) {
              renderStep(__2("Tap the Menu Icon", config.jsVars.slug), __2("Tap the menu icon (three dots) in the top-right corner of your browser window.", config.jsVars.slug), svg.horizThreeDots);
              renderStep(__2('Expand "Apps"', config.jsVars.slug), __2('Hover over the "Apps" menu item to expand its options.', config.jsVars.slug), svg.appsGrid);
              renderStep(__2('Select "Install this site as app"', config.jsVars.slug), __2('Click on "Install this site as app" from the menu.', config.jsVars.slug), svg.directionDown);
              renderStep(__2('Confirm by Clicking "Install"', config.jsVars.slug), __2(`Click the "Install" button in the browser's installation dialog.`, config.jsVars.slug), svg.mouseClick);
            } else {
              renderStep(__2("Copy the Page URL", config.jsVars.slug), __2("Click the button below to copy the page's URL.", config.jsVars.slug), svg.copy, this.renderCopyInstallUrlButton());
              renderStep(__2("Open the Google Chrome Browser", config.jsVars.slug), __2("Launch the Google Chrome web browser from your start menu.", config.jsVars.slug), svg.googleChrome);
              renderStep(__2("Paste and Open the URL", config.jsVars.slug), __2("Paste the copied URL into Google Chrome's address bar and open the page.", config.jsVars.slug), svg.pasteGo);
            }
          } else {
            renderStep(__2("Installation Not Supported", config.jsVars.slug), __2("Your device does not support web app installation. Please try accessing the website on a mobile or desktop device.", config.jsVars.slug), svg.noInstallSupport);
          }
    ...
    `);
          ...
          const promptTitle = config.jsVars.settings.installation?.prompts?.text ?? __2("Install Web App", config.jsVars.slug);
          const combinedStyles = Array.from(this.styles).join("\n");
          this.shadowRoot.innerHTML = `
        ...
        <div class="install-prompt-container">
          ...
          <div class="install-prompt-footer">
            <button type="button" class="install-prompt-footer_close">
              ${__2("Close Dialog", config.jsVars.slug)}
            </button>
          </div>
        </div>
      </div>
    ...
    "frontend/assets/js/dev/modules/installOverlayHeaderBanner.js"() {
      ...
      PwaInstallOverlayHeaderBanner = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config.jsVars.settings.installation?.prompts?.text ?? __3("Install Web App", config.jsVars.slug);
          const message = config.jsVars.settings.installation?.prompts?.types?.headerBanner?.message ?? __3("Get our web app. It won't take up space on your device.", config.jsVars.slug);
      ...
      <div class="header-banner-overlay">
        ...
        <div class="header-banner-overlay-buttons">
          <button type="button" class="header-banner-overlay-button_install">
            ${__3("Install Now", config.jsVars.slug)}
          </button>
    ...
    "frontend/assets/js/dev/modules/installOverlaySnackbar.js"() {
      ...
      PwaInstallOverlaySnackbar = class extends HTMLElement {
        ...
        render() {
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config.jsVars.settings.installation?.prompts?.text ?? __4("Install Web App", config.jsVars.slug);
          const message = config.jsVars.settings.installation?.prompts?.types?.snackbar?.message ?? __4("Installing uses no storage and offers a quick way back to our web app.", config.jsVars.slug);
          this.injectStyles(`
      .snackbar-overlay {
        display: flex;
        align-items: center;
    ...
    `);
      ...
      <div class="snackbar-overlay">
        ...
        <button type="button" class="snackbar-overlay-button_install">
          ${__4("Install Now", config.jsVars.slug)}
        </button>
      ...
      <div class="blog-popup-overlay">
        <div class="blog-popup-overlay-container">
          <div class="blog-popup-overlay-header">
            <div class="blog-popup-overlay-header_title">${__5("Read this article in our web app", config.jsVars.slug)}</div>
          </div>
          <div class="blog-popup-overlay-body">
            ...
            <div class="blog-popup-overlay-browserinfo">
              ...
              <button type="button" class="blog-popup-overlay-button -continue">
                ${__5("Continue", config.jsVars.slug)}
              </button>
            </div>     
          </div>
        </div>
    ...
    "frontend/assets/js/dev/modules/installOverlayNavigationMenu.js"() {
      ...
      PwaInstallOverlayNavigationMenu = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config.jsVars.settings.installation?.prompts?.text ?? __6("Install Web App", config.jsVars.slug);
          const message = config.jsVars.settings.installation?.prompts?.types?.navigationMenu?.message ?? __6("Find what you need faster by installing our web app!", config.jsVars.slug);
    ...
    `);
      ...
      <div class="navigation-menu-overlay">
        ...
        <button type="button" class="navigation-menu-overlay-button_install">
          ${__6("Install Now", config.jsVars.slug)}
        </button>
      </div>
    `;
        }
    ...
    "frontend/assets/js/dev/modules/installOverlayInFeed.js"() {
      ...
      PwaInstallOverlayInFeed = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config.jsVars.settings.installation?.prompts?.text ?? __7("Install Web App", config.jsVars.slug);
          const message = config.jsVars.settings.installation?.prompts?.types?.inFeed?.message ?? __7("Keep reading, even when you're on the train!", config.jsVars.slug);
    ...
    `);
      ...
      <div class="in-feed-overlay">
        ...
        <button type="button" class="in-feed-overlay-button_install">
          ${__7("Install Now", config.jsVars.slug)}
        </button>
      </div>
    `;
        }
    ...
    "frontend/assets/js/dev/modules/installOverlayWoocommerceCheckout.js"() {
      ...
      PwaInstallOverlayWoocommerceCheckout = class extends HTMLElement {
        ...
        render() {
          ...
          const themeColor = config.jsVars.settings.webAppManifest?.appearance?.themeColor ?? "#000000";
          const textColor = getContrastTextColor(themeColor);
          const title = config.jsVars.settings.installation?.prompts?.text ?? __8("Install Web App", config.jsVars.slug);
          const message = config.jsVars.settings.installation?.prompts?.types?.woocommerceCheckout?.message ?? __8("Keep track of your orders. Our web app is fast, small and works offline.", config.jsVars.slug);
    ...
    `);
      ...
      <div class="woocommerce-checkout-overlay">
        ...
        <button type="button" class="woocommerce-checkout-overlay-button_install">
          ${__8("Install Now", config.jsVars.slug)}
        </button>
      </div>
    `;
        }
      ...
      PwaOfflineNotification = class extends HTMLElement {
        ...
        static showReconnecting() {
          ...
          requestAnimationFrame(() => {
            ...
            text.textContent = __9("Connection lost. Attempting to reconnect...", config.jsVars.slug);
            setTimeout(() => {
        ...
        static showReconnected() {
          ...
          text.textContent = __9("Successfully reconnected to the internet!", config.jsVars.slug);
    ...
    `);
      ...
      <div class="offline-notification" role="alert" tabindex="-1">
        ...
        <span class="offline-notification_text">
          ${__9("Connection lost. Attempting to reconnect...", config.jsVars.slug)}
        </span>
      </div>
    `;
        }
        ...
        <div class="offline-form-handler-container">
          <div class="offline-form-handler-header">
            <div class="offline-form-handler-header-texts">
              ...
              <div class="offline-form-handler-header-texts_title">${__10("No Internet Connection", config.jsVars.slug)}</div>
            </div>
          </div>
          <div class="offline-form-handler-body">
            <div class="offline-form-handler-body_message">${__10("You\u2019re currently offline. Your form submission data will be saved and be automatically processed in the background when you\u2019re back online within 24 hours. Would you like to proceed?", config.jsVars.slug)}</div>
          </div>
      ...
      PwaPullDownRefresh = class extends HTMLElement {
        ...
        handleTouchMove(e) {
          ...
          if (pullDistance >= 0) {
            ...
            if (pullDistance > this.threshold) {
              statusText.textContent = __12("Release to refresh", config.jsVars.slug);
            } else {
              statusText.textContent = __12("Pull down to refresh", config.jsVars.slug);
            }
          }
        }
        async handleTouchEnd() {
          ...
          if (pullDistance > this.threshold) {
            ...
            statusText.textContent = __12("Refreshing...", config.jsVars.slug);
      ...
      <div class="pull-down-refresh" role="alert">
        <div class="pull-down-refresh_content">
          ...
          <span class="pull-down-refresh_text">
            ${__12("Pull down to refresh", config.jsVars.slug)}
          </span>
        </div>
      </div>
    `;
    ...
    `);
      ...
      <div class="shake-notification" role="alert">
        ...
        <span class="shake-notification_text">
          ${__13("Shake detected! Refreshing the page...", config.jsVars.slug)}
        </span>
      </div>
    `;
        }
    ...
    `);
          ...
          switch (true) {
            case config.jsVars.pageData.type.isHome:
              message = __14("Homepage Opened", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.is404:
              message = __14("Page Not Found", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isSearch:
              message = __14("Search Results", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isBlogPost:
              message = __14("Article Opened", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isWooShop:
              message = __14("Shop Opened", config.jsVars.slug);
              break;
            case config.jsVars.pageData.type.isWooProduct:
              message = __14("Product Opened", config.jsVars.slug);
              break;
            default:
              message = __14("Page Opened", config.jsVars.slug);
              break;
          }
          const combinedStyles = Array.from(this.styles).join("\n");
          this.shadowRoot.innerHTML = `
      ...
      <div class="idle-notification" role="alert" tabindex="-1">
        <div class="idle-notification_texts">
          ...
          <span class="idle-notification_text">
            ${__15("You've been idle for a while.", config.jsVars.slug)}
          </span>
        </div>
    ...
    "frontend/assets/js/dev/modules/pushNotificationsPrompt.js"() {
      ...
      PwaPushNotificationsPrompt = class _PwaPushNotificationsPrompt extends HTMLElement {
        ...
        render() {
          ...
          const backgroundColor = getContrastTextColor(themeColor);
          const textColor = getContrastTextColor(backgroundColor);
          const promptMessage = config.jsVars.settings.pushNotifications?.prompt?.message ?? __16("We would like to show you notifications for the latest news and updates.", config.jsVars.slug);
          const appName = config.jsVars.settings.webAppManifest.appIdentity.appName ?? "";
      ...
      <div class="push-notifications-prompt">
        <div class="push-notifications-prompt-media">
          ...
          <div class="push-notifications-prompt-media_texts">
            <div class="push-notifications-prompt-media_title">${__16("Push Notifications", config.jsVars.slug)}</div>
        ...
        <div class="push-notifications-prompt-buttons">
          <button type="button" class="push-notifications-prompt-button_dismiss">
            ${__16("Dismiss", config.jsVars.slug)}
          </button>
          <button type="button" class="push-notifications-prompt-button_allow">
            ${__16("Allow Notifications", config.jsVars.slug)}
          </button>
        </div>
      </div>
    `;
  ...
  var config, settings, userData, pluginsData, pageData;
