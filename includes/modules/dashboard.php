  ...
  public function fetchPwaScoreData()
  {
    $allActionItems = [
      'appStores' => [
        ...
        'title' => esc_html__('Publish your web app on app stores', $this->textDomain),
        'icon' =>
      ...
      'appIcon' => [
        ...
        'title' => esc_html__('Upload or select your PWA App Icon', $this->textDomain),
      ...
      'categories' => [
        ...
        'title' => esc_html__('Choose your PWA web app categories', $this->textDomain),
